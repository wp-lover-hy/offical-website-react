 ...
 * @LastEditors: Chen
 * @LastEditTime: 2025-09-14 10:15:25
 */
import React from 'react';
import styles from './AdvantagesSection.module.scss';
import iconAssest from '../../../../assets/images/icon-assest.png';
import iconPremium from '../../../../assets/images/icon-premium.png';
import iconFlow from '../../../../assets/images/icon-flow.png';
import iconExperience from '../../../../assets/images/icon-experience.png';
          ...
          {advantages.map((advantage, index) => (
            <div key={advantage.id} className={styles.advantageCard}>
              <div className={styles.iconContainer}>
                <img src={advantage.icon} style={{ width: advantage.imgWidth }} />
              </div>
